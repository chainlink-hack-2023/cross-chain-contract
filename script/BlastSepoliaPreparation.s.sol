...
contract BlastSepoliaPreparationScript is Script {
    ...
    function run() public {
        ...
        address BlastSepolia_WETH = 0x4200000000000000000000000000000000000023;

        IERC20(BlastSepolia_WETH).approve(_HUBSource, type(uint).max);
