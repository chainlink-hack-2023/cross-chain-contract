...
contract HUBScript is Script {
    ...
    function run() public {
        ...
        address Messager = 0x9338F298F29D3918D5D1Feb209aeB9915CC96333; // Blast L1 Sepolia Messager
        ...
        _HUBSource.setChainSelectors(168587773, 0);
        ...
        _HUBDestination.setChainSelectors(168587773, 0);
