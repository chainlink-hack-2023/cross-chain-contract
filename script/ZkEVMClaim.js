...
const HUBDestination = "0x0Cb9cf26d4Bc141a066A3AcDf3ff51Be6Fb7899F"
...
async function main() {
    ...
    const depositAxions = await axios.get(getClaimsFromAcc + HUBDestination, { params: { limit: 100, offset: 0 } });
